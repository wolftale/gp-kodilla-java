...
public class OrderProcessorExtraFoodShop implements SupplierOrderProcessor {
    private InformationService informationService;
    private OrderService orderService;
    private OrderRepository orderRepository;

    public OrderProcessorExtraFoodShop(final InformationService informationService,
